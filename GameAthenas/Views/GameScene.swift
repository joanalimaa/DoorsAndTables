 ...
 // let groundCategory: UInt32 = 1 << 1
    ...
    func setupDoor() {
       ...
       // doorTexture.filteringMode = .nearest
        ...
        let moveDoor = SKAction.moveBy(x: 0, y: -movingDistance - 130, duration: 2)
        ...
        let createDoorAnimation = SKAction.run ({
            ...
            leftDoorSpawn.position = CGPoint(x: -132, y: 200)
            ...
            rightDoorSpawn.position = CGPoint(x: 132, y: 200)
    ...
    func setupScoreLabel() {
        ...
        scoreLabelNode.position = CGPoint(x: 10, y: self.frame.size.height - 150)
